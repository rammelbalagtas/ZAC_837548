CLASS zcl_GE288635_SO_API DEFINITION
     PUBLIC
 FINAL
 CREATE PUBLIC .
 ...
 PUBLIC SECTION.
   ...
   TYPES:
     BEGIN OF tys_item_scheduline.
       INCLUDE TYPE zsc_GE288635_api_so=>tys_a_sales_order_item_type.
         TYPES : to_schedule_line TYPE  zsc_GE288635_api_so=>tyt_a_sales_order_schedule_l_2,
     ...
     BEGIN OF tys_salesorder_item_scheduline.
       INCLUDE TYPE zsc_GE288635_api_so=>tys_a_sales_order_type.
         TYPES : to_item TYPE tyt_item_scheduline,
     END OF tys_salesorder_item_scheduline,

     tyt_item_business_data       TYPE zsc_GE288635_api_so=>tyt_a_sales_order_item_type,
     tys_entity_key               TYPE zsc_GE288635_api_so=>tys_a_sales_order_type,
   ...
   CONSTANTS :
       c_proxy_model_key TYPE /iwbep/if_cp_runtime_types=>ty_s_proxy_model_key VALUE 'ZSC_GE288635_API_SO'.
...
CLASS zcl_GE288635_SO_API IMPLEMENTATION.
 METHOD constructor.
